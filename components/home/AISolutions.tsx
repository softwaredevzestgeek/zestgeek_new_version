...
const solutions = homeContent.aiSolutions.solutions;

export type SolutionContent = typeof solutions[number];

export function AiSolutions() {
  return (
    <section className="relative w-full min-h-screen bg-gradient-to-tr from-[#f4fbf7] via-white to-[#f0faf5] py-[100px] px-[135px] flex flex-col items-center justify-center font-sans overflow-hidden bg-gradient-to-b from-[#8CC33F03] via-white to-[#f0faf5]">
      ...
      <div className="w-full text-center relative z-10">
        ...
        <button className="inline-flex items-center gap-2 px-6 py-3 border border-[#8CC33F] bg-transparent text-[#529946] font-medium text-sm rounded-lg hover:bg-[#8CC33F] hover:text-white transition-all duration-300 shadow-sm group cursor-pointer font-['Inter'] font-medium">
